  ...
  const updateScrollButtons = () => {
    ...
    if (container) {
      ...
      const rightScrollable =
        container.scrollWidth > leftScroll + container.clientWidth + 100;
    ...
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Discover the latest styles traiight of the runway,l freshly added to
          keep your wardrobe on the cutting edge of fahsion.
        </p>
