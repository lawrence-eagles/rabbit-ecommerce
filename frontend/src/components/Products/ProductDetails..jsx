...
const selectedProduct = {
  ...
  price: 120,
  originalPrice: 150,
  description: "This is a stylish suite perfect for any occasion",
  brand: "FashionBrand",
  material: "Leather",
  sizes: ["s", "M", "L", "XL"],
  colors: ["Red", "Blue"],
  images: [
    {
      ...
      altText: "Stylish Suite 1",
    },
    {
      url: "https://picsum.photos/500/500?random=2",
      altText: "Stylish Suite 2",
    },
  ],
};

const ProductDetails = () => {
  const [mainImage, setMainImage] = useState(null); // the original use an empty string ""
          ...
          <div className="hidden md:flex flex-col space-y-4 mr-6">
            {selectedProduct.images.map((image, index) => (
              <img
                key={index}
                src={image.url}
                alt={image.altText || `Thunmbnail ${index}`}
